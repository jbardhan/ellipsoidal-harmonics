function [L, Lrb] = doAnalyticalRB(b, epsIn, epsOut, pqrData, Nmax)
% this is a modification of doAnalyical for the reduced basis
% method
...
for i=1:M
  ...
  Bnm_bibee = computeBnm_bibee_RB(b, Enm, epsIn, epsOut, Nmax);
  Lrb(:,i) = computePot(Bnm_bibee, pqrData, Nmax);
